...
public class HackGame {
    ...
    public void spiderGame1() throws IOException, InterruptedException, SQLException {
        ...
        if (ne != null) {
            ...
            System.out.println("[" + startDate + "][collider.com][Game 1] Don't have last news");
        } else {
            Thread.sleep(1000);
            ...
            System.out.println("["+startDate11+"][collider.com][Game 1] Get Last News");
...
//        System.out.println(noidung_all);
            ...
            System.out.println("["+startDate+"][collider.com][Game 1] Inert db done");
        }
    ...
    public void spiderGame2() throws IOException, InterruptedException, SQLException {
        ...
        if (ne != null) {
            ...
            SimpleDateFormat sdf1 = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
            String startDate = sdf1.format(date1);
            System.out.println("[" + startDate + "][collider.com][Game 2] Don't have last news");
        } else {
            Thread.sleep(1000);
            Getcontent getnd = new Getcontent();
            ArrayList<String> list_img_all = new ArrayList<>();
            ...
            SimpleDateFormat sdf11 = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
            String startDate11 = sdf11.format(date11);
            System.out.println("["+startDate11+"][collider.com][Game 2] Get Last News");
            GetImg getimg = new GetImg();
            String noidung_final = getnd.getnoidung(link);
            ArrayList<String> list_anh = getimg.GetImage(link);
            if (list_anh != null) {
...
//        System.out.println(noidung_all);
            ...
            New news = new New(id, title, "...", noidung_all, startDate, "Video Games", cover);
            nedao.insertNews(news);
            System.out.println("["+startDate+"][collider.com][Game 2] Inert db done");
        }
    ...
    public void spiderGame3() throws IOException, InterruptedException, SQLException {
        ...
        if (ne != null) {
            ...
            SimpleDateFormat sdf1 = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
            String startDate = sdf1.format(date1);
            System.out.println("[" + startDate + "][collider.com][Game 3] Don't have last news");
        } else {
            Thread.sleep(1000);
            Getcontent getnd = new Getcontent();
            ArrayList<String> list_img_all = new ArrayList<>();
            ...
            SimpleDateFormat sdf11 = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
            String startDate11 = sdf11.format(date11);
            System.out.println("["+startDate11+"][collider.com][Game 3] Get Last News");
            GetImg getimg = new GetImg();
            String noidung_final = getnd.getnoidung(link);
            ArrayList<String> list_anh = getimg.GetImage(link);
            if (list_anh != null) {
...
//        System.out.println(noidung_all);
            ...
            New news = new New(id, title, "...", noidung_all, startDate, "Video Games", cover);
            nedao.insertNews(news);
            System.out.println("["+startDate+"][collider.com][Game 3] Inert db done");
        }
    ...
    public void spiderGame4() throws IOException, InterruptedException, SQLException {
        ...
        if (ne != null) {
            ...
            SimpleDateFormat sdf1 = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
            String startDate = sdf1.format(date1);
            System.out.println("[" + startDate + "][collider.com][Game 4] Don't have last news");
        } else {
            Thread.sleep(1000);
            Getcontent getnd = new Getcontent();
            ArrayList<String> list_img_all = new ArrayList<>();
            ...
            SimpleDateFormat sdf11 = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
            String startDate11 = sdf11.format(date11);
            System.out.println("["+startDate11+"][collider.com][Game 4] Get Last News");
            GetImg getimg = new GetImg();
            String noidung_final = getnd.getnoidung(link);
            ArrayList<String> list_anh = getimg.GetImage(link);
            if (list_anh != null) {
...
//        System.out.println(noidung_all);
            ...
            New news = new New(id, title, "...", noidung_all, startDate, "Video Games", cover);
            nedao.insertNews(news);
            System.out.println("["+startDate+"][collider.com][Game 4] Inert db done");
        }
    ...
    public void spiderGame5() throws IOException, InterruptedException, SQLException {
        ...
        if (ne != null) {
            ...
            SimpleDateFormat sdf1 = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
            String startDate = sdf1.format(date1);
            System.out.println("[" + startDate + "][collider.com][Game 5] Don't have last news");
        } else {
            Thread.sleep(1000);
            Getcontent getnd = new Getcontent();
            ArrayList<String> list_img_all = new ArrayList<>();
            ...
            SimpleDateFormat sdf11 = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
            String startDate11 = sdf11.format(date11);
            System.out.println("["+startDate11+"][collider.com][Game 5] Get Last News");
            GetImg getimg = new GetImg();
            String noidung_final = getnd.getnoidung(link);
            ArrayList<String> list_anh = getimg.GetImage(link);
            if (list_anh != null) {
...
//        System.out.println(noidung_all);
            ...
            New news = new New(id, title, "...", noidung_all, startDate, "Video Games", cover);
            nedao.insertNews(news);
            System.out.println("["+startDate+"][collider.com][Game 5] Inert db done");
        }
