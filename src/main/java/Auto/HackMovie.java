 ...
 * @author ShacoJX
 */
public class HackMovie {
    public void spiderMovie1() throws IOException, InterruptedException, SQLException {
...
//        System.out.println(noidung_all);
    ...
    public void spiderMovie2() throws IOException, InterruptedException, SQLException {
        OkHttpClient client = new OkHttpClient().newBuilder()
                .connectTimeout(30, TimeUnit.SECONDS)
                .readTimeout(30, TimeUnit.SECONDS)
                .writeTimeout(30, TimeUnit.SECONDS)
...
//        System.out.println(noidung_all);
    ...
    public void spiderMovie3() throws IOException, InterruptedException, SQLException {
        OkHttpClient client = new OkHttpClient().newBuilder()
                .connectTimeout(30, TimeUnit.SECONDS)
                .readTimeout(30, TimeUnit.SECONDS)
                .writeTimeout(30, TimeUnit.SECONDS)
...
//        System.out.println(noidung_all);
    ...
    public void spiderMovie4() throws IOException, InterruptedException, SQLException {
        OkHttpClient client = new OkHttpClient().newBuilder()
                .connectTimeout(30, TimeUnit.SECONDS)
                .readTimeout(30, TimeUnit.SECONDS)
                .writeTimeout(30, TimeUnit.SECONDS)
...
//        System.out.println(noidung_all);
    ...
    public void spiderMovie5() throws IOException, InterruptedException, SQLException {
        OkHttpClient client = new OkHttpClient().newBuilder()
                .connectTimeout(30, TimeUnit.SECONDS)
                .readTimeout(30, TimeUnit.SECONDS)
                .writeTimeout(30, TimeUnit.SECONDS)
