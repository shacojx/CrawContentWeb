 ...
 * @author ShacoJX
 */
public class HackTrailers {
     public void spiderTrailer1() throws IOException, InterruptedException, SQLException {
        ...
        Request request = new Request.Builder()
                .url("https://collider.com/trailers/")
                .method("GET", null)
...
//        System.out.println(noidung_all);
     ...
     public void spiderTrailer2() throws IOException, InterruptedException, SQLException {
        OkHttpClient client = new OkHttpClient().newBuilder()
                .connectTimeout(30, TimeUnit.SECONDS)
                .readTimeout(30, TimeUnit.SECONDS)
                .writeTimeout(30, TimeUnit.SECONDS)
...
//        System.out.println(noidung_all);
     ...
     public void spiderTrailer3() throws IOException, InterruptedException, SQLException {
        OkHttpClient client = new OkHttpClient().newBuilder()
                .connectTimeout(30, TimeUnit.SECONDS)
                .readTimeout(30, TimeUnit.SECONDS)
                .writeTimeout(30, TimeUnit.SECONDS)
...
//        System.out.println(noidung_all);
     ...
     public void spiderTrailer4() throws IOException, InterruptedException, SQLException {
        OkHttpClient client = new OkHttpClient().newBuilder()
                .connectTimeout(30, TimeUnit.SECONDS)
                .readTimeout(30, TimeUnit.SECONDS)
                .writeTimeout(30, TimeUnit.SECONDS)
...
//        System.out.println(noidung_all);
     ...
     public void spiderTrailer5() throws IOException, InterruptedException, SQLException {
        OkHttpClient client = new OkHttpClient().newBuilder()
                .connectTimeout(30, TimeUnit.SECONDS)
                .readTimeout(30, TimeUnit.SECONDS)
                .writeTimeout(30, TimeUnit.SECONDS)
