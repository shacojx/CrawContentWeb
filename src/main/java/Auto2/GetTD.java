 ...
 */
public class GetTD {
    public String GetTieuDe(String url) throws IOException{
        ...
        String[] List_1 = html_resp.split("</title>");
        String tmp1 = List_1[0];
        String[] List_2 = tmp1.split("<title>");
        String tmp2 = List_2[1];
        return tmp2.trim();
    }
//    public static void main(String[] args) throws IOException {
//        GetTD g = new GetTD();
//        System.out.println(g.GetTieuDe("https://movieweb.com/pirates-of-the-caribbean-6-johnny-depp-greg-ellis/"));
//    }
}
